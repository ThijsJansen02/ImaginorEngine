...
set include=/I%solutiondir% /I%prjdir% /I%solutiondir%\ImaginorMath\src /I%prjdir%\dep\include /I%prjdir%\dep\Entt\single_include
set defines=/DIME_DEBUG /DIME_DLL_BUILD
set libs=
set compilorflags=/std:c++17 /Zi /MD /Fe:ImaginorEngine.dll
