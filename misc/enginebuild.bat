...
set srcfiles= %prjdir%\src\rendering\Renderer2D.cpp %prjdir%\src\memory.cpp %prjdir%\src\userinterface\Context.cpp %prjdir%\src\userinterface\Window.cpp %prjdir%\src\textrenderering.cpp %prjdir%\src\assets.cpp
set include=/I%solutiondir% /I%prjdir% /I%solutiondir%\ImaginorMath\src /I%prjdir%\dep\include /I%prjdir%\dep\Entt\src\
set libfiles= memory.obj Context.obj window.obj textrenderering.obj Renderer2D.obj assets.obj
